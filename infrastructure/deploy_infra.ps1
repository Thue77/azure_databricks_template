...
New-AzResourceGroupDeployment -TemplateFile $TemplateFile -Confirm  -azureADObjectID $azureADObjectID -projectName $projectName -shortLocation $shortLoaction -Mode $mode -environment $environment
